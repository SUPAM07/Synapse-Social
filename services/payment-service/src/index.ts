...
import { startPaymentConsumer } from './infrastructure/messaging/kafka.consumer';
...
const start = async (): Promise<void> => {
  ...
  app.listen(config.port, () => logger.info(`Payment service running on port ${config.port}`));
};
